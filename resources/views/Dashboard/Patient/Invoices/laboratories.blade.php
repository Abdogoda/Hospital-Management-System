                                        ...
                                        <table style="text-align: center" class="table text-md-nowrap" id="example1">
                                           ...
                                           @foreach($laboratories as $laboratorie)
                                               <tr>
                                                   ...
                                                   <td>
                                                        @if($laboratorie->description !== null)
                                                   ...
                                                   <td>
                                                       @if($laboratorie->employee_id !== null)
                                                           {{$laboratorie->LaboratoryEmployee->name}}
                                                       @else
                                                           ---------------
                                                       @endif                                                 
                                                   </td>
                                                   <td>
                                                     @if($laboratorie->description_employee !== null)
                                                            {{$laboratorie->description_employee}}
                                                     @else
                                                         ---------------
                                                     @endif
                                                   </td>
                                                   <td>
                                                       @if($laboratorie->employee_id !== null)
                                                           <a class="btn btn-primary btn-sm" href="{{route('ShowPatientLaboratory',$laboratorie->id)}}" role="button">عرض التحليل</a>
                                                       @else
                                                           ---------------
                                                       @endif                                                   
                                                   </td>
