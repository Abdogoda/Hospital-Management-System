...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="left-content">
						<div>
						  <h2 class="main-content-title tx-24 mg-b-1 mg-b-lg-1">لوحة تحكم المشرفين</h2>
						  <p class="mg-b-0">مرحبا {{Auth()->user()->name}} اهلا بعودتك مجددا!</p>
						</div>
					</div>
					<div class="main-dashboard-header-right">
						<div>
							<label class="tx-13">اجمالي الخدمات المفردة</label>
							<h5>{{App\Models\Invoice::count()}}</h5>
						</div>
						<div>
							<label class="tx-13">اجمالي الخدمات المجمعة</label>
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										...
										<span class="float-right my-auto mr-auto">
											...
											<span class="text-white op-7">{{App\Models\Doctor::count()}}</span>
										</span>
									</div>
								</div>
							</div>
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										...
										<span class="float-right my-auto mr-auto">
											...
											<span class="text-white op-7">{{App\Models\Patient::count()}}</span>
										</span>
									</div>
								</div>
							</div>
							...
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										...
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-up text-white"></i>
											<span class="text-white op-7">{{App\Models\Section::count()}}</span>
										</span>
									</div>
								</div>
							</div>
							...
							<div class="pl-3 pt-3 pr-3 pb-2 pt-0">
								...
								<div class="pb-0 mt-0">
									<div class="d-flex">
										...
										<span class="float-right my-auto mr-auto">
											<i class="fas fa-arrow-circle-down text-white"></i>
											<span class="text-white op-7">{{App\Models\RayEmployee::count()}}</span>
										</span>
									</div>
								</div>
							</div>
