...
@section('content')
    ...
    <div class="demo-gallery">
        <ul id="lightgallery" class="list-unstyled row row-sm pr-0">
            ...
            <li class="col-sm-6 col-lg-4" data-responsive="{{URL::asset('storage/Dashboard/img/rays/'.$image->filename)}}" data-src="{{URL::asset('storage/Dashboard/img/rays/'.$image->filename)}}">
                <a href="#">
                    <img width="50px" height="350px" class="img-responsive" src="{{URL::asset('storage/Dashboard/img/rays/'.$image->filename)}}" alt="NoImg">
                </a>
            </li>
            @endforeach
        </ul>
