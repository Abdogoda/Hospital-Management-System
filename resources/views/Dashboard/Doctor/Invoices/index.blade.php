                                        ...
                                        <table class="table text-nowrap" id="example1">
                                           ...
                                           @foreach($invoices as $invoice)
                                               <tr>
                                                   ...
                                                   <td><a href="{{route('PatientDetails',$invoice->patient_id)}}">{{ $invoice->Patient->name }}</a></td>
                                                   ...
                                                   <td>
                                                       <div class="dropdown">
                                                           <button aria-expanded="false" aria-haspopup="true" class="btn ripple btn-outline-secondary btn-sm" data-toggle="dropdown" type="button">العمليات<i class="fas fa-caret-down mr-1"></i></button>
