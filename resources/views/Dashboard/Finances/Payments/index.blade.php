                            ...
                            <div class="card">
                                <div class="card-header pb-0">
                                    <div class="d-flex justify-content-between">
                                        <a href="{{route('Payments.create')}}" class="btn btn-primary" role="button"
                                        ...
                                        <table class="table text-md-nowrap" id="example1">
                                           ...
                                           @foreach($payments as $payment)
                                               <tr>
                                                   ...
                                                   <td>
                                                       <a href="{{route('Payments.edit',$payment->id)}}" class="btn btn-sm btn-primary"><i class="fas fa-edit"></i></a>
                                                       ...
                                                       <a href="{{route('Payments.show',$payment->id)}}" target="_blank" class="btn btn-sm btn-success" ><i class="las la-print"></i></a>
                                                    </td>
                                               </tr>
                                           @include('Dashboard.Finances.Payments.delete')
                                           @endforeach
                                            </tbody>
                                        </table>
                                    </div>
