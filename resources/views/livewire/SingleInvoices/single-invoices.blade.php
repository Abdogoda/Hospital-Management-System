<div>
    ...
    @if ($catchError)
        <div class="alert alert-danger" id="success-danger">
            <button class="close" type="button" data-dismiss="alert">{{$catchError}}</button>
        </div>
    @endif
    ...
    @if ($InvoiceDeleted)
        <div class="alert alert-info">تم حذف البيانات بنجاح.</div>
    @endif
    ...
    <form wire:submit.prevent="store" autocomplete="off">
                ...
                <button class="btn btn-outline-secondary" wire:click="hide_form_add" type="button">الغاء</button><br><br>
            </form>
