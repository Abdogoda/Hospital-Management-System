...
<div class="table-responsive">
    <table class="table text-nowrap" id="example1" data-page-length="50"style="text-align: center">
        <thead>
        <tr>
            <th>#</th>
            <th>اسم الخدمة</th>
        ...
        @foreach ($group_invoices as $group_invoice)
            <tr>
                ...
                <td>
                    ...
                    <a href="#"  wire:click="print({{ $group_invoice->id }})" class="btn btn-success btn-sm" title="طباعه سند صرف"><i class="fas fa-print"></i></a>
                </td>
            </tr>
