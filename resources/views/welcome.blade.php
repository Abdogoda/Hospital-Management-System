...
@section('content')
                    ...
                    <div class="auto-container">
                        <div class="row clearfix">
                            ...
                            <div class="image-column col-lg-6 col-md-12 col-sm-12">
                                <div class="inner-column">
                                    <div class="image">
                                        <img src="{{URL::asset('Website/images/gallery/doctors.jpg')}}" alt="image"/>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="auto-container">
                        <div class="row clearfix">
                            ...
                            <div class="image-column col-lg-6 col-md-12 col-sm-12">
                                <div class="inner-column">
                                    <div class="image">
                                        <img src="{{URL::asset('Website/images/main-slider/3.jpg')}}" alt="image"/>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="row clearfix">
                    ...
                    <div class="image-column col-lg-5 col-md-12 col-sm-12">
                        <div class="inner-column wow fadeInRight" data-wow-delay="0ms" data-wow-duration="1500ms">
                            <div class="image">
                                <img src="{{URL::asset('Website/images/resource/image-3.jpg')}}" alt="image"/>
                            </div>
                        </div>
                    </div>
    ...
    <section class="department-section-three">
        <div class="image-layer" style="background-image:url({{URL::asset('Website/images/background/6.jpg')}}"></div>
        <div class="auto-container">
            <!-- Department Tabs-->
        ...
        <div class="auto-container">
            ...
            <div class="row clearfix">
                ...
                <div class="team-block col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <div class="image">
                            <img src="{{URL::asset('Website/images/resource/team-1.jpg')}}" alt="image"/>
                ...
                <div class="team-block col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <div class="inner-box wow fadeInLeft" data-wow-delay="250ms" data-wow-duration="1500ms">
                        <div class="image">
                            <img src="{{URL::asset('Website/images/resource/team-2.jpg')}}" alt="image"/>
                            <div class="overlay-box">
                                <ul class="social-icons">
                                    <li><a href="#"><span class="fab fa-facebook-f"></span></a></li>
                                    <li><a href="#"><span class="fab fa-google"></span></a></li>
                ...
                <div class="team-block col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <div class="inner-box wow fadeInLeft" data-wow-delay="500ms" data-wow-duration="1500ms">
                        <div class="image">
                            <img src="{{URL::asset('Website/images/resource/team-3.jpg')}}" alt="image"/>
                            <div class="overlay-box">
                                <ul class="social-icons">
                                    <li><a href="#"><span class="fab fa-facebook-f"></span></a></li>
                                    <li><a href="#"><span class="fab fa-google"></span></a></li>
                ...
                <div class="team-block col-lg-3 col-md-6 col-sm-6 col-xs-12">
                    <div class="inner-box wow fadeInLeft" data-wow-delay="750ms" data-wow-duration="1500ms">
                        <div class="image">
                            <img src="{{URL::asset('Website/images/resource/team-4.jpg')}}" alt="image"/>
                            <div class="overlay-box">
                                <ul class="social-icons">
                                    <li><a href="#"><span class="fab fa-facebook-f"></span></a></li>
                                    <li><a href="#"><span class="fab fa-google"></span></a></li>
                ...
                <div class="row clearfix">
                    ...
                    <div class="image-column col-lg-6 col-md-12 col-sm-12">
                        <div class="inner-column wow slideInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                            <div class="image">
                                <img src="{{URL::asset('Website/images/resource/doctor-2.png')}}" alt="image"/>
                            </div>
                        </div>
                    </div>
        ...
        <div class="auto-container">
            ...
            <div class="testimonial-carousel owl-carousel owl-theme">
                ...
                <div class="testimonial-block-two">
                    <div class="inner-box">
                        <div class="image">
                            <img src="{{URL::asset('Website/images/resource/author-4.jpg')}}" alt="image"/>
                        </div>
                        <div class="text">
                ...
                <div class="testimonial-block-two">
                    <div class="inner-box">
                        <div class="image">
                            <img src="{{URL::asset('Website/images/resource/author-5.jpg')}}" alt="image"/>
                        </div>
                        <div class="text">
                            يعد المركز الطبي مكانًا رائعًا للحصول على جميع احتياجاتك الطبية. دخلت
                            لإجراء فحص ولم تنتظر أكثر من 5 دقائق قبل رؤيتي. يمكنني أن أتصور
        ...
        <div class="auto-container">
            ...
            <div class="row clearfix">
                ...
                <div class="news-block-two col-lg-6 col-md-12 col-sm-12">
                    <div class="inner-box">
                        <div class="image">
                            <a href="blog-detail.html"><img src="{{URL::asset('Website/images/resource/news-4.jpg')}}" alt="image"/></a>
                        </div>
                        <div class="lower-content">
                            <div class="content">
                                <ul class="post-info">
                ...
                <div class="news-block-two col-lg-6 col-md-12 col-sm-12">
                    <div class="inner-box">
                        <div class="image">
                            <a href="blog-detail.html"><img src="{{URL::asset('Website/images/resource/news-5.jpg')}}" alt="image"/></a>
                        </div>
                        <div class="lower-content">
                            <div class="content">
                                <ul class="post-info">
        ...
        <div class="outer-container">
            ...
            <div class="sponsors-outer">
                ...
                <ul class="sponsors-carousel owl-carousel owl-theme">
                    <li class="slide-item">
                        <figure class="image-box"><a href="#"><img src="{{URL::asset('Website/images/clients/1.png')}}" alt="image"></a></figure>
                    </li>
                    <li class="slide-item">
                        <figure class="image-box"><a href="#"><img src="{{URL::asset('Website/images/clients/2.png')}}" alt="image"></a></figure>
                    </li>
                    <li class="slide-item">
                        <figure class="image-box"><a href="#"><img src="{{URL::asset('Website/images/clients/3.png')}}" alt="image"></a></figure>
                    </li>
                    <li class="slide-item">
                        <figure class="image-box"><a href="#"><img src="{{URL::asset('Website/images/clients/4.png')}}" alt="image"></a></figure>
                    </li>
                    <li class="slide-item">
                        <figure class="image-box"><a href="#"><img src="{{URL::asset('Website/images/clients/5.png')}}" alt="image"></a></figure>
                    </li>
                    <li class="slide-item">
                        <figure class="image-box"><a href="#"><img src="{{URL::asset('Website/images/clients/1.png')}}" alt="image"></a></figure>
                    </li>
